...
def create(main_parent):
    ...
    TODO: Implement spreadsheet-like editing
    TODO: Implement export section
    TODO: Refactor
    """
    #
    mod_frame = cmds.frameLayout(label='Modify / Export existing', parent=main_parent,
                                 width=WIN_W, collapsable=True, collapse=True)

    # Modify layout
    mod_layout = cmds.columnLayout(rs=ROW_SP, parent=mod_frame)

    # Scan buttons row
    mod_row_scan_btn = cmds.rowLayout(numberOfColumns=3,
                                      columnWidth3=(15, WIN_W / 2 - 15,
                                                    WIN_W / 2 - 10),
                                      parent=mod_layout)
    ...
    cmds.text(
        ...
        font='obliqueLabelFont', align='center', width=WIN_W, parent=mod_layout
    )
    cmds.separator(height=10, width=WIN_W, style='in', parent=mod_layout)
    ...
    cmds.separator(height=10, width=WIN_W, style='in')
